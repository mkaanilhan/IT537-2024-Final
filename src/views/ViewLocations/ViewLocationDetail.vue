                ...
                <div class="content p-5 has-text-grey-light">
                  ...
                  <p class="is-size-6 mb-2 has-text-grey">
                    ...
                    <span class="has-text-dark">{{
                      storeLocations.location.id
                    }}</span>
                  </p>
                  <p class="is-size-6 mb-2 has-text-grey">
                    Dimension:
                    <span class="has-text-dark">{{
                      storeLocations.location.dimension
                    }}</span>
                  </p>
                  <p class="is-size-6 mb-2 has-text-grey">
                    Type:
                    <span class="has-text-dark">{{
                      storeLocations.location.type
                    }}</span>
                  </p>
                  <p class="is-size-6 mb-2 has-text-grey">
                    Created Date:
                    <span class="has-text-dark">{{
                      storeLocations.location.created.slice(0, 10)
                    }}</span>
                  </p>
                </div>
              </div>
